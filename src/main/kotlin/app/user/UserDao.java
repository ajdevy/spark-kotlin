...
public class UserDao {
    ...
    private final java.util.List<User> users = com.google.common.collect.ImmutableList.of(
            ...
            new User("ae",  "$2a$10$e0MYzXyjpJS7Pd0RVvHwHe", "$2a$10$e0MYzXyjpJS7Pd0RVvHwHe1HlCS4bZJ18JuywdEMLT83E1KDmUhCy"),
    ...
    public Iterable<String> getAllUserNames() {
        return users.stream().map(User::getUsername).collect(java.util.stream.Collectors.toList());
    }
}